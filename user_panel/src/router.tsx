...
export const router = createBrowserRouter([
  ...
  { path: '/cafes', element: <Suspense fallback={<PageFallback />}><CafeListPage /></Suspense> },
  { path: '/cafes/:restaurantId/menu', element: <Suspense fallback={<PageFallback />}><MenuPage /></Suspense> },
